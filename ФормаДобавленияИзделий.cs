...
namespace Mebel
{
    public partial class ФормаДобавленияИзделий : Form
    {
        ...
        int koId = 0;
        int loId = 0;
        public ФормаДобавленияИзделий(SqlConnection sqlConnect, Form f)
        {
        ...
        private void ФормаДобавленияИзделий_Load(object sender, EventArgs e)
        {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
                    ...
                    cmd.CommandText = "INSERT INTO Изделие ([Мастер],[Наименование],[Количество],[ЗатраченнаяСумма],[Итого],[ДатаИзготовления],[idЗатраченной],[idМастера],[idНаименования]) values ('" + textBox6.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + dateTimePicker1.Value + "','"+koId+ "','"+loId+ "','"+oId+ "')";
